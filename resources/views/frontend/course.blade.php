...
<header id="header">
	...
	<div class="uk-container uk-container-large">
		...
		style="background-image: url(https://placehold.co/1240x600);">
			<div class="uk-padding-large">
				<div data-uk-grid>
					<div class="uk-width-expand@m uk-flex uk-flex-middle uk-light">
						<div>
							<a class="uk-text-demi-bold hvr-back" href="index.html"><span class="uk-margin-small-right" 
								data-uk-icon="icon: arrow-left; ratio: 1.4"></span>Back</a>
							<h1 class="uk-heading-small uk-letter-spacing-medium">User Experience Design Fundamentals For Beginners</h1>
					...
					<div class="uk-width-1-3@m uk-flex uk-flex-middle">
						<div class="uk-inline uk-light uk-border-rounded-large uk-box-shadow-small uk-overflow-hidden">
							<img src="https://placehold.co/640x400.png" alt="Video">
          ...
          <div class="uk-margin-large-top">
            ...
            <div data-uk-grid>
              <div class="uk-width-auto uk-flex uk-flex-middle">
                <img class="uk-border-circle" src="https://placehold.co/80x80" alt="Tom Solender">
              </div>
                ...
                <header class="uk-comment-header uk-position-relative">
                  <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                    <div class="uk-width-auto">
                      <img class="uk-comment-avatar uk-border-circle" src="https://placehold.co/80x80" width="80" height="80" alt="Alice Thomson">
                    </div>
                    <div class="uk-width-expand">
                ...
                <li>
                  <article class="uk-comment uk-comment-primary uk-visible-toggle" tabindex="-1">
                    <header class="uk-comment-header uk-position-relative">
                      <div class="uk-grid-medium uk-flex-middle" data-uk-grid>
                        <div class="uk-width-auto">
                          <img class="uk-comment-avatar uk-border-circle" src="https://placehold.co/80x80" width="80" height="80" alt="Tom Solender">
                        </div>
                        <div class="uk-width-expand">
