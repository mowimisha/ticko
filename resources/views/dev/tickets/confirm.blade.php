...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet">
        ...
        @if(Auth::user()->hasRole('dev'))
            <!--begin::Form-->
            <form class="kt-form" method="POST" action="{{ url('validate-tickets-dev') }}" enctype="multipart/form-data"  role="search" autocomplete="off" id="receivingForm">
                    {{ csrf_field() }}
        ...
        @elseif(Auth::user()->hasRole('admin'))
            <!--begin::Form-->
            <form class="kt-form" method="POST" action="{{ url('validate-tickets') }}" enctype="multipart/form-data"  role="search" autocomplete="off" id="receivingForm">
                    {{ csrf_field() }}
